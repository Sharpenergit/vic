...
document.addEventListener('DOMContentLoaded', function(){
    ...
    axios
      .get('https://crudcrud.com/api/dcee623d50df4f2fa157d073b5b37d79/Appointment', {
        timeout: 5000
      })
...
let  linode=document.createElement("li")
    ...
    edit.addEventListener("click",function(){
      ...
      axios
      .delete('https://crudcrud.com/api/dcee623d50df4f2fa157d073b5b37d79/Appointment/'+res._id)
...
let id;
    ...
    axios
          .post('https://crudcrud.com/api/dcee623d50df4f2fa157d073b5b37d79/Appointment', {
            Name:a,
            email:b,
            phno:c
          })
    ...
    let d=a+"-"+b+"-"+c
     ...
     edit.addEventListener("click",function(){
        ...
        axios
        .delete('https://crudcrud.com/api/dcee623d50df4f2fa157d073b5b37d79/Appointment/'+id)
        .then(res=>console.log(id))
        .catch(err => console.error(err))
